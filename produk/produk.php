                   ...
                   <table border="1" cellspacing="0" class="table">
                       ...
                       <tbody>
                           ...
                           <tr>
                               ...
                               <td><a href="../image/<?php echo $row['image_product'] ?>" target="_blank"><img src="../image/<?php echo $row['image_product'] ?>" width="50px"></a></td>
                               <td><?php echo ($row['status_product'] == 0)? 'Tidak Aktif':'Aktif'; ?></td>
                               <td>
                                   <a href="edit-produk.php?id=<?php echo $row['id_product']?>">Edit</a> || <a href="../hapus/hapus-produk.php?id=<?php echo $row['id_product'] ?>" onclick="return confirm('Yakin Ingin Hapus ?')">Hapus</a>
                               </td>
                           </tr>
                           <?php }} else{ ?>
