               ...
               <div class="box">
                   <table border="1" cellspacing="0" class="table">
                       ...
                       <tbody>
                           <?php
                           $no = 1;
                           $produk = mysqli_query($conn, "SELECT * FROM pembayaran ORDER BY id DESC");
                           ...
                           <tr>
                               ...
                               <td><a href="../image/<?php echo $row['image'] ?>" target="_blank"><img src="../image/<?php echo $row['image'] ?>" width="50px"></a></td>
                               <td><?php echo $row['np_hp'] ?></td>
                               <td>
                                    <a href="../hapus/hapus-pembeli.php?id=<?php echo $row['id'] ?>" onclick="return confirm('Yakin Ingin Hapus ?')">Hapus</a>
                               </td>
                           </tr>
                           <?php }} else{ ?>
